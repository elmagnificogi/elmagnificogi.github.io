...
![image-20220912200209819](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202209122002873.png)
...
![image-20221113151821448](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202211131518499.png)

找到他的具体设置，可以看到应该是由CSV文件决定的

![image-20221113151934279](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202211131519313.png)

csv中的内容如下：

![image-20221113151750190](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202211131517257.png)

实际这个芯片是4M大小，给了APP 1MB，给了nvs 24KB

但是实际可用大小，还需要考虑到实际存储头等消耗，所以具体应该只有20567大小

![image-20221113152409588](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202211131524625.png)

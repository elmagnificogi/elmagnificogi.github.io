...
量化投资，通过一系列分析计算、进行定点、定量的投资，每一笔交易都是有据可循有理可依的，而非通过人的感觉去投资，程序化的自动投资，将情绪波动降到了最低点。（评论区老哥说的时候我还不懂什么叫量化，但是我自己在思考的时候有想过通过建立一个模型，通过财报、舆论等等去评估一个股票或者公司，进而给出来他的价格的最高点，估值，和他真正的价值，从而给出提示，完成低买高卖的操作）

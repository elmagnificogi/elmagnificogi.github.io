...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/9ZLfFlx1Po6InCK.png)

竟然还有IDE缓存这么一说？？感觉没见过，先看看，因为默认的.idea文件也早没了，我根本没抱期望

第一次点开这个Local History，直接是灰色的，而且Show History 根本不能点。

![](https://img.elmagnifico.tech/static/upload/elmagnifico/92fW5SP8GjXkHlN.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/HZDeqW4cOw89igb.png)

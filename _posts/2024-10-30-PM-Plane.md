...
description: "Plane项目管理部署和试用，docker plane、makeplane、plane是什么、plane docker 部署、PingCode、Gitlab。"
date:       2024-10-30
update:     2026-05-27
author:     "elmagnifico"
...
我们基于plane selfhost 做了一个中文翻译的插件，不过限定了我们的域名，总体很简单，字符替换就行了，给不太熟悉中文的朋友用足够了

...
![image-20220722210805361](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202207222108397.png)



~~**经常需要重启之类的操作，并不能长时间有效，如果要高稳定性，还是得考虑其他方式，至少安卓APP不靠谱，可以试一试PC客户端的Hook类型，可能更稳一些**~~

使用其他的人APP，总算是稳定多了，~~前面严重的每单都漏，重启都没用~~
...
![image-20220722210109788](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202207222101863.png)

如果出现了`手机通知关闭`，那么就算支付了，手机里也能看到支付的信息，但是实际上通知栏是没有这条消息的，也就无法触发监控。

如果出现了`手机通知关闭`，可以点击打开如下界面，关闭手机静音的选项，从而可以正常收到支付通知

![image-20220722210427069](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202207222104110.png)

正常显示应该是这样的

![image-20220722210638450](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/202207222106485.png)

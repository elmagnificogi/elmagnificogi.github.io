...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5c00a7de11c43.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5c00a7fc6904d.png)

简单说你先有NB-IoT节点，节点通过现有运营商部署的基站，将信息传递给运营商端，然后运营商将信息转发给IoT平台（华为），然后我们可以通过华为提供的平台API或者插件等，对信息进行编解码，然后获取到我们需要的信息

![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5c00a814ac879.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcb47c22fb.png)

联通测试资费标准:

![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcb47c29a7.png)

目前只有电信是实际部署了,而联通还在测试阶段(只有部分地区可以用),移动还没有牌照.

关于响应速度,说法不一致,华为的官方说法大概是从发指令到响应是10s,有些情况是6s,但是并没有具体说明,有人测试的说法大概是1-2s,这个要具体实测才能知道

![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcb8db52c9.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcbbed4cf7.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffccdd15926.png)

![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcd3e72d26.png)

可以看到就算选择C型,其消息天生自带的延时等待下行消息就很长.

![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffccdd17604.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcc3534758.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcc9139280.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcc54ec11a.png)
...
![](http://img.elmagnifico.tech:9514/static/upload/elmagnifico/5bffcc3540830.png)

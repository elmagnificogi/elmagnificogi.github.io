...
之后都是以此类推最终得到最后的解
	...
	例：
		...
		那么就需要得到这样的结果
			...
			再次用4位压缩	 0010 0011 0010 0011 0011 0100 0010 0010
...
那就等于 99=100-10+10-1=XCIX
	  ...
	  XX, 20  XXI, 21     XXII, 22     XXIX, 29       XXX, 30    XXXIV, 34        XXXV, 35       XXXIX, 39     XL, 40    L, 50       LI, 51    LV, 55     LX, 60     LXV, 65   LXXX, 80      XC, 90      XCIII, 93    XCV, 95     XCVIII, 98      XCIX, 99   

...
description: "LeetCode Solution(Easy.17-20)，c++、python、17.Ugly Number、18.Happy Number。"
date:       2015-12-9
author:     "elmagnifico"
...
如果这个数可以直接整除235 然后判断一次是否可以继续整除，如果还可以 再判断， 直到剩下1或者是剩下的不可整除，就结束了
...
合并两个有序链表，没啥难的，就是不知道这个链表是什么顺序排列的 一般应该是由小到大吧

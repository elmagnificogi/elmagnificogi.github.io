...
这里就看到规律了，每四子会出现一个赢或者是输的判断，谁先给对方创造了四的倍数子，那么谁就会赢。
...
下面这个方法就避免了双层循环，只是多了一个度节点，用来保存深度信息，这样就无脑遍历就可以了。
...
3. 如果删除得是其他节点，同上，用下一个节点代替当前要删除的节点，然后删除下一节点。
...
public:
    void deleteNode(ListNode* node) 
    {
        ...
        //如果下下个节点不存在,原节点改成下一节点,然后删除最后的节点
